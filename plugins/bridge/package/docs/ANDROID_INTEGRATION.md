...
This guide explains how to integrate the `@gyo/bridge` Android native code into your Android project.
...
After installing `@gyo/bridge`, find the native code at:

```
node_modules/@gyo/bridge/android/src/main/kotlin/gyo/plugins/bridge/
```
